<template>
  <div class="home">
    <div class="text-h3">欢迎使用WxBotClient</div>
    <div class="text-body-1 mt-2">
      加群交流体验内测新功能，领取最新内测安装包自行制作微信AI助手！
    </div>
    <div class="text-body-1 mt-2">
      目前ChatGPT使用的ApiKey是作者私人的，用的人多可能会有些慢，如果不稳定请多多谅解，如果更改自己的APIKey可以在群里问群主或者去GitHub看文档自己修改哦~
    </div>
    <div class="text-body-1 mt-2">
...
import { openai, sendMessage } from "@/bot/chatgpt/main";
