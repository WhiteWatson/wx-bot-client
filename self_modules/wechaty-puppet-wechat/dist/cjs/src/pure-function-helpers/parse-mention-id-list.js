...
async function parseMentionIdList(puppet, roomId, text) {
    wechaty_puppet_1.log.verbose('Message', 'mention()');
    ...
    wechaty_puppet_1.log.silly('wechaty-puppet-wechat', 'mentionIdList(%s), mentionNameList = "%s"', text, JSON.stringify(mentionNameList));
    ...
    if (contactIdList.length === 0) {
        wechaty_puppet_1.log.silly('wechaty-puppet-wechat', [
...
exports.parseMentionIdList = parseMentionIdList;
//# sourceMappingURL=parse-mention-id-list.js.map