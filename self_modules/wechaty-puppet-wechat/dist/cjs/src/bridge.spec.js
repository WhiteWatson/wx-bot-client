...
const bridge_js_1 = __importDefault(require("./bridge.js"));
...
(0, tstest_1.test)('PuppetWeChatBridge restart', async (t) => {
    ...
    while (ttl-- > 0) {
        try {
            bridge = new bridge_js_1.default({ memory });
            await bridge.start();
            await bridge.stop();
...
/* eslint indent: off */
(0, tstest_1.test)('preHtmlToXml()', async (t) => {
...
(0, tstest_1.test)('clickSwitchAccount()', async (t) => {
